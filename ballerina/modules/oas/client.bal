...
public isolated client class Client {
    ...
    remote isolated function acceptsACancellationRequest(string apiVersion, string fulfillmentOrderId, CancellationRequestAcceptJsonBody payload, map<string|string[]> headers = {}) returns CancellationResponse|error {
    ...
    remote isolated function acceptsAFulfillmentRequest(string apiVersion, string fulfillmentOrderId, FulfillmentRequestAcceptJsonBody payload, map<string|string[]> headers = {}) returns AcceptFulfillmentResponse|error {
    ...
    remote isolated function addsAProductToACustomCollection(string apiVersion, ApiVersionCollectsJsonBody payload, map<string|string[]> headers = {}) returns ProductToCollectionResponse|error {
    ...
    remote isolated function adjustsTheInventoryLevelOfAnInventoryItemAtALocation(string apiVersion, InventoryLevelsAdjustJsonBody payload, map<string|string[]> headers = {}) returns InventoryLevel|error {
    ...
    remote isolated function appliesAFulfillmentHoldOnAnOpenFulfillmentOrder(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdHoldJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function approvesAComment(string apiVersion, string commentId, record {} payload, map<string|string[]> headers = {}) returns ApproveCommentResponse|error {
    ...
    remote isolated function calculatesARefund(string apiVersion, string orderId, RefundsCalculateJsonBody payload, map<string|string[]> headers = {}) returns CalculateRefund|error {
    ...
    remote isolated function cancelAFulfillmentOrder(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdCancelJsonBody payload, map<string|string[]> headers = {}) returns CancelFulfillmentOrder|error {
    ...
    remote isolated function cancelAnOrder(string apiVersion, string orderId, record {} payload, map<string|string[]> headers = {}) returns OrderResponse|error {
    ...
    remote isolated function cancelsAFulfillment(string apiVersion, string fulfillmentId, record {} payload, map<string|string[]> headers = {}) returns CancelFulfillment|error {
    ...
    remote isolated function cancelsARecurringApplicationCharge(string apiVersion, string recurringApplicationChargeId, string payload, map<string|string[]> headers = {}) returns string|error {
    ...
    remote isolated function closeAnOrder(string apiVersion, string orderId, record {} payload, map<string|string[]> headers = {}) returns CloseOrderResponse|error {
    ...
    remote isolated function completeADraftOrder(string apiVersion, string draftOrderId, string payload, map<string|string[]> headers = {}) returns CompleteDraftOrder|error {
    ...
    remote isolated function completesACheckout(string apiVersion, string token, record {} payload, map<string|string[]> headers = {}) returns CompleteCheckoutResponse|error {
    ...
    remote isolated function connectsAnInventoryItemToALocation(string apiVersion, InventoryLevelsConnectJsonBody payload, map<string|string[]> headers = {}) returns ConnectInventoryItem|error {
    ...
    remote isolated function countsTheNumberOfPaymentsAttemptedOnACheckout(string apiVersion, string token, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    remote isolated function createACollectionListingToPublishACollectionToYourApp(string apiVersion, string collectionListingId, CollectionListingscollectionListingIdJsonBody payload, map<string|string[]> headers = {}) returns CollectionListing|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function createAMetafield(string apiVersion, string ownerId, string ownerResource, OwnerResourceMetafieldsJsonBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    remote isolated function createAMobilePlatformApplication(string apiVersion, ApiVersionMobilePlatformApplicationsJsonBody payload, map<string|string[]> headers = {}) returns MobilePlatformApplication|error {
    ...
    remote isolated function createANewBlog(string apiVersion, ApiVersionBlogsJsonBody payload, map<string|string[]> headers = {}) returns CreateBlogResponse|error {
    ...
    remote isolated function createANewDraftorder(string apiVersion, ApiVersionDraftOrdersJsonBody payload, map<string|string[]> headers = {}) returns CreateDraftOrder|error {
    ...
    remote isolated function createANewFulfillmentservice(string apiVersion, ApiVersionFulfillmentServicesJsonBody payload, map<string|string[]> headers = {}) returns CreateFulfillmentService|error {
    ...
    remote isolated function createANewPage(string apiVersion, ApiVersionPagesJsonBody payload, map<string|string[]> headers = {}) returns PageResponse|error {
    ...
    remote isolated function createANewProductImage(string apiVersion, string productId, ProductIdImagesJsonBody payload, map<string|string[]> headers = {}) returns CreateProductImage|error {
    ...
    remote isolated function createANewProductResourcefeedback(string apiVersion, string productId, ProductIdResourceFeedbackJsonBody payload, map<string|string[]> headers = {}) returns ResourceFeedbackList|error {
    ...
    remote isolated function createANewProductVariant(string apiVersion, string productId, CreateProductVariant payload, map<string|string[]> headers = {}) returns CreateProductVariant|error {
    ...
    remote isolated function createANewResourcefeedback(string apiVersion, ApiVersionResourceFeedbackJsonBody payload, map<string|string[]> headers = {}) returns CreateShopFeedback|error {
    ...
    remote isolated function createANewWebhook(string apiVersion, CreateWebhook payload, map<string|string[]> headers = {}) returns SubscribeOrderCreation|error {
    ...
    remote isolated function createAProductListingToPublishAProductToYourApp(string apiVersion, string productListingId, ProductListingsproductListingIdJsonBody payload, map<string|string[]> headers = {}) returns ProductListingAppResponse|error {
    ...
    remote isolated function createAnOrder(string apiVersion, CreateOrder payload, map<string|string[]> headers = {}) returns OrderResponse|error {
    ...
    remote isolated function createsACarrierService(string apiVersion, ApiVersionCarrierServicesJsonBody payload, map<string|string[]> headers = {}) returns CreateCarrierService|error {
    ...
    remote isolated function createsACheckout(string apiVersion, ApiVersionCheckoutsJsonBody payload, map<string|string[]> headers = {}) returns CreateCheckoutResponse|error {
    ...
    remote isolated function createsACommentForAnArticle(string apiVersion, ApiVersionCommentsJsonBody payload, map<string|string[]> headers = {}) returns ArticleComment|error {
    ...
    remote isolated function createsACountry(string apiVersion, ApiVersionCountriesJsonBody payload, map<string|string[]> headers = {}) returns CreateCountry|error {
    ...
    remote isolated function createsACustomCollection(string apiVersion, ApiVersionCustomCollectionsJsonBody payload, map<string|string[]> headers = {}) returns CreateCollection|error {
    ...
    remote isolated function createsACustomer(string apiVersion, CreateCustomer payload, map<string|string[]> headers = {}) returns CustomerResponse|error {
    ...
    remote isolated function createsADiscountCode(string apiVersion, string priceRuleId, PriceRuleIdDiscountCodesJsonBody payload, map<string|string[]> headers = {}) returns CreateDiscountCode|error {
    ...
    remote isolated function createsADiscountCodeCreationJob(string apiVersion, string priceRuleId, PriceRuleIdBatchJsonBody payload, map<string|string[]> headers = {}) returns DiscountCode|error {
    ...
    remote isolated function createsAFulfillmentEvent(string apiVersion, string orderId, string fulfillmentId, FulfillmentIdEventsJsonBody payload, map<string|string[]> headers = {}) returns CreateFulfillmentEvent|error {
    ...
    remote isolated function createsAFulfillmentForOneOrManyFulfillmentOrders(string apiVersion, CreateOrderFulfillment payload, map<string|string[]> headers = {}) returns CreateFulfillmentOrder|error {
    ...
    remote isolated function createsAGiftCard(string apiVersion, ApiVersionGiftCardsJsonBody payload, map<string|string[]> headers = {}) returns GiftCard|error {
    ...
    remote isolated function createsAMarketingEvent(string apiVersion, ApiVersionMarketingEventsJsonBody payload, map<string|string[]> headers = {}) returns CreateMarketingEvent|error {
    ...
    remote isolated function createsANewAddressForACustomer(string apiVersion, string customerId, CustomerIdAddressesJsonBody payload, map<string|string[]> headers = {}) returns CustomerAddress|error {
    ...
    remote isolated function createsANewPayment(string apiVersion, string token, TokenPaymentsJsonBody payload, map<string|string[]> headers = {}) returns CreateAuthorizationResponse|error {
    ...
    remote isolated function createsANewProduct(string apiVersion, CreateProduct payload, map<string|string[]> headers = {}) returns CreateProductResponse|error {
    ...
    remote isolated function createsANewReport(string apiVersion, ApiVersionReportsJsonBody payload, map<string|string[]> headers = {}) returns ReportResponse|error {
    ...
    remote isolated function createsANewScriptTag(string apiVersion, ApiVersionScriptTagsJsonBody payload, map<string|string[]> headers = {}) returns ScriptTagResponse|error {
    ...
    remote isolated function createsANewStorefrontaccesstoken(string apiVersion, ApiVersionStorefrontAccessTokensJsonBody payload, map<string|string[]> headers = {}) returns StorefrontAccessToken|error {
    ...
    remote isolated function createsAPriceRule(string apiVersion, ApiVersionPriceRulesJsonBody payload, map<string|string[]> headers = {}) returns PriceRule|error {
    ...
    remote isolated function createsARecurringApplicationCharge(string apiVersion, ApiVersionRecurringApplicationChargesJsonBody payload, map<string|string[]> headers = {}) returns ApplicationChargeResponse|error {
    ...
    remote isolated function createsARedirect(string apiVersion, ApiVersionRedirectsJsonBody payload, map<string|string[]> headers = {}) returns RedirectResponse|error {
    ...
    remote isolated function createsARefund(string apiVersion, string orderId, CreateRefund payload, map<string|string[]> headers = {}) returns RefundObject|error {
    ...
    remote isolated function createsASmartCollection(string apiVersion, ApiVersionSmartCollectionsJsonBody payload, map<string|string[]> headers = {}) returns CreatSmartCollection|error {
    ...
    remote isolated function createsATheme(string apiVersion, ApiVersionThemesJsonBody payload, map<string|string[]> headers = {}) returns CreateThemeResponse|error {
    ...
    remote isolated function createsATransactionForAnOrder(string apiVersion, string orderId, CreateTransaction payload, map<string|string[]> headers = {}) returns TransactionObject|error {
    ...
    remote isolated function createsAUsageCharge(string apiVersion, string recurringApplicationChargeId, RecurringApplicationChargeIdUsageChargesJsonBody payload, map<string|string[]> headers = {}) returns UsageChargeResponse|error {
    ...
    remote isolated function createsAnAccountActivationUrlForACustomer(string apiVersion, string customerId, CustomerInvite payload, map<string|string[]> headers = {}) returns AccountActivationUrl|error {
    ...
    remote isolated function createsAnApplicationCharge(string apiVersion, ApiVersionApplicationChargesJsonBody payload, map<string|string[]> headers = {}) returns ApplicationCharge|error {
    ...
    remote isolated function createsAnArticleForABlog(string apiVersion, string blogId, BlogIdArticlesJsonBody payload, map<string|string[]> headers = {}) returns Article|error {
    ...
    remote isolated function createsAnOrderRiskForAnOrder(string apiVersion, string orderId, CreateOrderRisk payload, map<string|string[]> headers = {}) returns CreateOrderRisk|error {
    ...
    remote isolated function createsMarketingEngagementsOnAMarketingEvent(string apiVersion, string marketingEventId, MarketingEventIdEngagementsJsonBody payload, map<string|string[]> headers = {}) returns Engagements|error {
    ...
    remote isolated function createsOrUpdatesAnAssetForATheme(string apiVersion, string themeId, ThemeIdAssetsJsonBody payload, map<string|string[]> headers = {}) returns ImageAsset|error {
    ...
    remote isolated function deleteACollectionListingToUnpublishACollectionFromYourApp(string apiVersion, string collectionListingId, string payload, map<string|string[]> headers = {}) returns string|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/collection_listings/${getEncodedUri(collectionListingId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function deleteADisputeEvidenceFile(string apiVersion, string disputeId, string disputeFileUploadId, map<string|string[]> headers = {}) returns error? {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function deleteAMobilePlatformApplication(string apiVersion, string mobilePlatformApplicationId, string payload, map<string|string[]> headers = {}) returns error? {
    ...
    remote isolated function deleteAProductListingToUnpublishAProductFromYourApp(string apiVersion, string productListingId, string payload, map<string|string[]> headers = {}) returns string|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/product_listings/${getEncodedUri(productListingId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deletesACarrierService(string apiVersion, string carrierServiceId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesACustomCollection(string apiVersion, string customCollectionId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesACustomer(string apiVersion, string customerId, string payload, map<string|string[]> headers = {}) returns CustomerResponse|error {
    ...
    remote isolated function deletesADiscountCode(string apiVersion, string priceRuleId, string discountCodeId, string payload, map<string|string[]> headers = {}) returns string|error {
    ...
    remote isolated function deletesAFulfillmentEvent(string apiVersion, string orderId, string fulfillmentId, string eventId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAMarketingEvent(string apiVersion, string marketingEventId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function deletesAMetafieldByItsId(string apiVersion, string ownerId, string ownerResource, string metafieldId, string payload, map<string|string[]> headers = {}) returns error? {
    ...
    remote isolated function deletesAPage(string apiVersion, string pageId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAProduct(string apiVersion, string productId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesARedirect(string apiVersion, string redirectId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAReport(string apiVersion, string reportId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAScriptTag(string apiVersion, string scriptTagId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAnArticle(string apiVersion, string blogId, string articleId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAnAssetFromATheme(string apiVersion, string themeId, string payload, map<string|string[]> headers = {}) returns DeleteAssetResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/themes/${getEncodedUri(themeId)}/assets.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deletesAnExistingStorefrontAccessToken(string apiVersion, string storefrontAccessTokenId, string payload, map<string|string[]> headers = {}) returns string|error {
    ...
    remote isolated function deletesAnInventoryLevelFromALocation(string apiVersion, string payload, map<string|string[]> headers = {}) returns string|error {
    ...
    remote isolated function deletesAnOrder(string apiVersion, string orderId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function deletesAnOrderRiskForAnOrder(string apiVersion, string orderId, string riskId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function disablesAGiftCard(string apiVersion, string giftCardId, GiftCardIdDisableJsonBody payload, map<string|string[]> headers = {}) returns DisableGiftCard|error {
    ...
    remote isolated function getAMobilePlatformApplication(string apiVersion, string mobilePlatformApplicationId, map<string|string[]> headers = {}) returns MobilePlatformApplicationResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/mobile_platform_applications/${getEncodedUri(mobilePlatformApplicationId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function listAllOfTheMobilePlatformApplicationsAssociatedWithTheApp(string apiVersion, map<string|string[]> headers = {}) returns MobilePlatformApplications|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/mobile_platform_applications.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function marksACommentAsNotSpam(string apiVersion, string commentId, record {} payload, map<string|string[]> headers = {}) returns MarkCommentResponse|error {
    ...
    remote isolated function marksACommentAsSpam(string apiVersion, string commentId, record {} payload, map<string|string[]> headers = {}) returns SpamCommentResponse|error {
    ...
    remote isolated function marksAFulfillmentOrderAsIncomplete(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdCloseJsonBody payload, map<string|string[]> headers = {}) returns TransitionFulfillmentOrder|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Move a fulfillment order to a new location / Move a fulfillment order to a new location 
    remote isolated function marksTheFulfillmentOrderAsOpen(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdOpenJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function modifiesAnExistingCheckout(string apiVersion, string token, CheckoutstokenJsonBody payload, map<string|string[]> headers = {}) returns ShippingRateResponse|UpdateCheckoutResponse|error {
    ...
    remote isolated function modifyAnExistingBlog(string apiVersion, string blogId, BlogsblogIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateBlogResponse|error {
    ...
    remote isolated function modifyAnExistingCarrierservice(string apiVersion, string carrierServiceId, CarrierServicescarrierServiceIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateCarrierService|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/carrier_services/${getEncodedUri(carrierServiceId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function modifyAnExistingDraftorder(string apiVersion, string draftOrderId, DraftOrdersdraftOrderIdJsonBody payload, map<string|string[]> headers = {}) returns ModifyDraftOrder|error {
    ...
    remote isolated function modifyAnExistingFulfillmentservice(string apiVersion, string fulfillmentServiceId, FulfillmentServicesfulfillmentServiceIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateFulfillmentService|error {
    ...
    remote isolated function modifyAnExistingProductImage(string apiVersion, string productId, string imageId, ImagesimageIdJsonBody payload, map<string|string[]> headers = {}) returns ModifyProductImage|error {
    ...
    remote isolated function modifyAnExistingProductVariant(string apiVersion, string variantId, UpdateProductVariant payload, map<string|string[]> headers = {}) returns ModifyProductVariant|error {
    ...
    remote isolated function modifyAnExistingTheme(string apiVersion, string themeId, ThemesthemeIdJsonBody payload, map<string|string[]> headers = {}) returns PublishThemeResponse|error {
    ...
    remote isolated function modifyAnExistingWebhook(string apiVersion, string webhookId, UpdateWebhook payload, map<string|string[]> headers = {}) returns WebhookObject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Move a fulfillment order to a new location / Move a fulfillment order to a new location 
    remote isolated function movesAFulfillmentOrderToANewLocation(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdMoveJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function performsBulkOperationsForMultipleCustomerAddresses(string apiVersion, string customerId, string payload, map<string|string[]> headers = {}) returns json|error {
    ...
    remote isolated function reOpenAClosedOrder(string apiVersion, string orderId, record {} payload, map<string|string[]> headers = {}) returns ReopenCloseOrder|error {
    ...
    remote isolated function receiveACountOfAllBlogs(string apiVersion, map<string|string[]> headers = {}) returns BlogsCount|error {
    ...
    remote isolated function receiveACountOfAllDraftorders(string apiVersion, map<string|string[]> headers = {}, *ReceiveACountOfAllDraftordersQueries queries) returns StoreLocationCount|error {
    ...
    remote isolated function receiveACountOfAllProductImages(string apiVersion, string productId, map<string|string[]> headers = {}, *ReceiveACountOfAllProductImagesQueries queries) returns BlogsCount|error {
    ...
    remote isolated function receiveACountOfAllProductVariants(string apiVersion, string productId, map<string|string[]> headers = {}) returns ArticlesCount|error {
    ...
    remote isolated function receiveACountOfAllWebhooks(string apiVersion, map<string|string[]> headers = {}, *ReceiveACountOfAllWebhooksQueries queries) returns ObjectCount|error {
    ...
    remote isolated function receiveAListOfAllCountries(string apiVersion, map<string|string[]> headers = {}, *ReceiveAListOfAllCountriesQueries queries) returns CountriesList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/countries.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveAListOfAllFulfillmentservices(string apiVersion, map<string|string[]> headers = {}, *ReceiveAListOfAllFulfillmentservicesQueries queries) returns FulfillmentServicesList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/fulfillment_services.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveAListOfAllProductImages(string apiVersion, string productId, map<string|string[]> headers = {}, *ReceiveAListOfAllProductImagesQueries queries) returns ProductImages|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}/images.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveAListOfAllProductResourcefeedbacks(string apiVersion, string productId, map<string|string[]> headers = {}) returns ResourceFeedbackList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}/resource_feedback.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveAListOfAllResourcefeedbacks(string apiVersion, map<string|string[]> headers = {}) returns ResourceFeedbackList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/resource_feedback.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function receiveAListOfAllShippingzones(string apiVersion, map<string|string[]> headers = {}, *ReceiveAListOfAllShippingzonesQueries queries) returns ShippingZonesList|error {
    ...
    remote isolated function receiveASingleArticle(string apiVersion, string blogId, string articleId, map<string|string[]> headers = {}, *ReceiveASingleArticleQueries queries) returns SingleArticle|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs/${getEncodedUri(blogId)}/articles/${getEncodedUri(articleId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleBlog(string apiVersion, string blogId, map<string|string[]> headers = {}, *ReceiveASingleBlogQueries queries) returns SingleBlog|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs/${getEncodedUri(blogId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleDraftorder(string apiVersion, string draftOrderId, map<string|string[]> headers = {}, *ReceiveASingleDraftorderQueries queries) returns SingleDraftOrder|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/draft_orders/${getEncodedUri(draftOrderId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleFulfillment(string apiVersion, string orderId, string fulfillmentId, map<string|string[]> headers = {}, *ReceiveASingleFulfillmentQueries queries) returns SingleFulfillment|error {
    ...
    remote isolated function receiveASingleFulfillmentservice(string apiVersion, string fulfillmentServiceId, map<string|string[]> headers = {}) returns SingleFulfillmentService|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/fulfillment_services/${getEncodedUri(fulfillmentServiceId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleProductImage(string apiVersion, string productId, string imageId, map<string|string[]> headers = {}, *ReceiveASingleProductImageQueries queries) returns SingleProductImage|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}/images/${getEncodedUri(imageId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleProductVariant(string apiVersion, string variantId, map<string|string[]> headers = {}, *ReceiveASingleProductVariantQueries queries) returns ProductVariantResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/variants/${getEncodedUri(variantId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function receiveASingleWebhook(string apiVersion, string webhookId, map<string|string[]> headers = {}, *ReceiveASingleWebhookQueries queries) returns SingleWebhook|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/webhooks/${getEncodedUri(webhookId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function rejectsACancellationRequest(string apiVersion, string fulfillmentOrderId, CancellationRequestRejectJsonBody payload, map<string|string[]> headers = {}) returns RejectCancellationRequestResponse|error {
    ...
    remote isolated function rejectsAFulfillmentRequest(string apiVersion, string fulfillmentOrderId, FulfillmentRequestRejectJsonBody payload, map<string|string[]> headers = {}) returns RejectFulfillmentResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Move a fulfillment order to a new location / Move a fulfillment order to a new location 
    remote isolated function releasesTheFulfillmentHoldOnAFulfillmentOrder(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdReleaseHoldJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function removeAnExistingBlog(string apiVersion, string blogId, string payload, map<string|string[]> headers = {}) returns record {}|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs/${getEncodedUri(blogId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removeAnExistingCountry(string apiVersion, string countryId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function removeAnExistingDraftorder(string apiVersion, string draftOrderId, string payload, map<string|string[]> headers = {}) returns record {}|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/draft_orders/${getEncodedUri(draftOrderId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removeAnExistingFulfillmentservice(string apiVersion, string fulfillmentServiceId, string payload, map<string|string[]> headers = {}) returns record {}|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/fulfillment_services/${getEncodedUri(fulfillmentServiceId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removeAnExistingPriceRule(string apiVersion, string priceRuleId, string payload, map<string|string[]> headers = {}) returns string|error {
    ...
    remote isolated function removeAnExistingProductImage(string apiVersion, string productId, string imageId, string payload, map<string|string[]> headers = {}) returns record {}|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}/images/${getEncodedUri(imageId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removeAnExistingProductVariant(string apiVersion, string productId, string variantId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function removeAnExistingTheme(string apiVersion, string themeId, string payload, map<string|string[]> headers = {}) returns DeleteThemeResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/themes/${getEncodedUri(themeId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removeAnExistingWebhook(string apiVersion, string webhookId, string payload, map<string|string[]> headers = {}) returns record {}|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/webhooks/${getEncodedUri(webhookId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function removesAComment(string apiVersion, string commentId, record {} payload, map<string|string[]> headers = {}) returns RemoveCommentResponse|error {
    ...
    remote isolated function removesAProductFromACollection(string apiVersion, string collectId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function removesASmartCollection(string apiVersion, string smartCollectionId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function removesAnAddressFromACustomerSAddressList(string apiVersion, string customerId, string addressId, string payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Move a fulfillment order to a new location / Move a fulfillment order to a new location 
    remote isolated function reschedulesTheFulfillAtTimeOfAScheduledFulfillmentOrder(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdRescheduleJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function restoresAPreviouslyRemovedComment(string apiVersion, string commentId, record {} payload, map<string|string[]> headers = {}) returns RestoreRemoveComment|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function retrieveACountOfAResourceSMetafields(string apiVersion, string ownerId, string ownerResource, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    remote isolated function retrieveACountOfProductsThatArePublishedToYourApp(string apiVersion, map<string|string[]> headers = {}) returns BlogsCount|error {
    ...
    remote isolated function retrieveAListOfAllBlogs(string apiVersion, map<string|string[]> headers = {}, *RetrieveAListOfAllBlogsQueries queries) returns Blogs|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrieveAListOfMetafieldsFromTheResourceSEndpoint(string apiVersion, string ownerId, string ownerResource, map<string|string[]> headers = {}, *RetrieveAListOfMetafieldsFromTheResourceSEndpointQueries queries) returns MetafieldList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/${getEncodedUri(ownerId)}/${getEncodedUri(ownerResource)}/metafields.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrieveAListOfProductsBelongingToACollection(string apiVersion, string collectionId, map<string|string[]> headers = {}, *RetrieveAListOfProductsBelongingToACollectionQueries queries) returns ProductsList|error {
    ...
    remote isolated function retrieveASpecificCollectionListingThatIsPublishedToYourApp(string apiVersion, string collectionListingId, map<string|string[]> headers = {}) returns CollectionListing|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/collection_listings/${getEncodedUri(collectionListingId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrieveASpecificMetafield(string apiVersion, string ownerId, string ownerResource, string metafieldId, map<string|string[]> headers = {}, *RetrieveASpecificMetafieldQueries queries) returns MetafieldResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/${getEncodedUri(ownerId)}/${getEncodedUri(ownerResource)}/metafields/${getEncodedUri(metafieldId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrieveASpecificProductListingThatIsPublishedToYourApp(string apiVersion, string productListingId, map<string|string[]> headers = {}) returns ProductListingAppResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/product_listings/${getEncodedUri(productListingId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrieveCollectionListingsThatArePublishedToYourApp(string apiVersion, map<string|string[]> headers = {}, *RetrieveCollectionListingsThatArePublishedToYourAppQueries queries) returns CollectionListingResponse|error {
    ...
    remote isolated function retrieveProductIdsThatArePublishedToACollectionId(string apiVersion, string collectionListingId, map<string|string[]> headers = {}, *RetrieveProductIdsThatArePublishedToACollectionIdQueries queries) returns ProductIds|error {
    ...
    remote isolated function retrieveProductIdsThatArePublishedToYourApp(string apiVersion, map<string|string[]> headers = {}, *RetrieveProductIdsThatArePublishedToYourAppQueries queries) returns ProductIdAppResponse|error {
    ...
    remote isolated function retrieveProductListingsThatArePublishedToYourApp(string apiVersion, map<string|string[]> headers = {}, *RetrieveProductListingsThatArePublishedToYourAppQueries queries) returns ProductListings|error {
    ...
    remote isolated function retrievesACheckout(string apiVersion, string token, map<string|string[]> headers = {}) returns CompleteCheckout|CheckoutResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/checkouts/${getEncodedUri(token)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesACountOfAllMarketingEvents(string apiVersion, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfAllPriceRules(string apiVersion, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfAllScriptTags(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfAllScriptTagsQueries queries) returns BlogsCount|error {
    ...
    remote isolated function retrievesACountOfAnOrderSTransactions(string apiVersion, string orderId, map<string|string[]> headers = {}) returns EventsCount|error {
    ...
    remote isolated function retrievesACountOfCheckouts(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfCheckoutsQueries queries) returns CheckoutCount|error {
    ...
    remote isolated function retrievesACountOfCollects(string apiVersion, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfComments(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfCommentsQueries queries) returns BlogsCount|error {
    ...
    remote isolated function retrievesACountOfCountries(string apiVersion, map<string|string[]> headers = {}) returns CountriesCount|error {
    ...
    remote isolated function retrievesACountOfCustomCollections(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfCustomCollectionsQueries queries) returns BlogsCount|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function retrievesACountOfCustomers(string apiVersion, map<string|string[]> headers = {}) returns EventsCount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function retrievesACountOfDiscountCodesForAShop(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfDiscountCodesForAShopQueries queries) returns EventsCount|error {
    ...
    remote isolated function retrievesACountOfEvents(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfEventsQueries queries) returns EventsCount|error {
    ...
    remote isolated function retrievesACountOfFulfillmentsAssociatedWithASpecificOrder(string apiVersion, string orderId, map<string|string[]> headers = {}, *RetrievesACountOfFulfillmentsAssociatedWithASpecificOrderQueries queries) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfGiftCards(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfGiftCardsQueries queries) returns EventsCount|error {
    ...
    remote isolated function retrievesACountOfLocations(string apiVersion, map<string|string[]> headers = {}) returns StoreLocationCount|error {
    ...
    remote isolated function retrievesACountOfProducts(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfProductsQueries queries) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfProvincesForACountry(string apiVersion, string countryId, map<string|string[]> headers = {}) returns ProvincesCount|error {
    ...
    remote isolated function retrievesACountOfSmartCollections(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfSmartCollectionsQueries queries) returns ObjectCount|error {
    ...
    remote isolated function retrievesACountOfUrlRedirects(string apiVersion, map<string|string[]> headers = {}, *RetrievesACountOfUrlRedirectsQueries queries) returns EventsCount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function retrievesADetailedListForInventoryItemsByIds(string apiVersion, map<string|string[]> headers = {}, *RetrievesADetailedListForInventoryItemsByIdsQueries queries) returns error? {
    ...
    remote isolated function retrievesADiscountCodeCreationJob(string apiVersion, string priceRuleId, string batchId, map<string|string[]> headers = {}) returns DiscountCodeResponse|error {
    ...
    remote isolated function retrievesAListOfAbandonedCheckouts(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfAbandonedCheckoutsQueries queries) returns AbandonedCheckouts|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/checkouts.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAddressesForACustomer(string apiVersion, string customerId, map<string|string[]> headers = {}) returns AddressList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers/${getEncodedUri(customerId)}/addresses.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAllArticleAuthors(string apiVersion, map<string|string[]> headers = {}) returns ArticleAuthors|error {
    ...
    remote isolated function retrievesAListOfAllArticleTags(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfAllArticleTagsQueries queries) returns TagsList|error {
    ...
    remote isolated function retrievesAListOfAllArticleTagsFromASpecificBlog(string apiVersion, string blogId, map<string|string[]> headers = {}, *RetrievesAListOfAllArticleTagsFromASpecificBlogQueries queries) returns Articles|error {
    ...
    remote isolated function retrievesAListOfAllArticlesFromABlog(string apiVersion, string blogId, map<string|string[]> headers = {}, *RetrievesAListOfAllArticlesFromABlogQueries queries) returns Articles|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs/${getEncodedUri(blogId)}/articles.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAllMarketingEvents(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfAllMarketingEventsQueries queries) returns MarketingEvents|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/marketing_events.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAllOrderRisksForAnOrder(string apiVersion, string orderId, map<string|string[]> headers = {}) returns OrderRisks|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/risks.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAllScriptTags(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfAllScriptTagsQueries queries) returns ScriptTagsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/script_tags.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAllUsers(string apiVersion, map<string|string[]> headers = {}) returns UsersList|error {
    ...
    remote isolated function retrievesAListOfApplicationCharges(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfApplicationChargesQueries queries) returns ApplicationChargesList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/application_charges.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfAssetsForATheme(string apiVersion, string themeId, map<string|string[]> headers = {}, *RetrievesAListOfAssetsForAThemeQueries queries) returns AssetsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/themes/${getEncodedUri(themeId)}/assets.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfCarrierServices(string apiVersion, map<string|string[]> headers = {}) returns CarrierServiceList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/carrier_services.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfCollects(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfCollectsQueries queries) returns CollectsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/collects.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfComments(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfCommentsQueries queries) returns ArticleComments|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/comments.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfCurrenciesEnabledOnAShop(string apiVersion, map<string|string[]> headers = {}) returns CurrenciesList|error {
    ...
    remote isolated function retrievesAListOfCustomCollections(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfCustomCollectionsQueries queries) returns CollectionList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/custom_collections.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfCustomers(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfCustomersQueries queries) returns Customers|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfDiscountCodes(string apiVersion, string priceRuleId, map<string|string[]> headers = {}) returns DiscountCodes|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules/${getEncodedUri(priceRuleId)}/discount_codes.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfDiscountCodesForADiscountCodeCreationJob(string apiVersion, string priceRuleId, string batchId, map<string|string[]> headers = {}) returns DiscountCodeList|error {
    ...
    remote isolated function retrievesAListOfDraftOrders(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfDraftOrdersQueries queries) returns DraftOrders|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/draft_orders.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfEvents(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfEventsQueries queries) returns EventsList|error {
    ...
    remote isolated function retrievesAListOfFulfillmentEventsForASpecificFulfillment(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfFulfillmentEventsForASpecificFulfillmentQueries queries) returns FulfillmentEvents|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(queries.orderId)}/fulfillments/${getEncodedUri(queries.fulfillmentId)}/events.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        return self.clientEp->get(resourcePath, headers);
    ...
    remote isolated function retrievesAListOfFulfillmentOrdersForASpecificOrder(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfFulfillmentOrdersForASpecificOrderQueries queries) returns FulfillmentOrdersList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(queries.orderId)}/fulfillment_orders.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        return self.clientEp->get(resourcePath, headers);
    ...
    remote isolated function retrievesAListOfGiftCards(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfGiftCardsQueries queries) returns GiftCardsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/gift_cards.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfInventoryLevels(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfInventoryLevelsQueries queries) returns InventoryLevels|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/inventory_levels.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfInventoryLevelsForALocation(string apiVersion, string locationId, map<string|string[]> headers = {}) returns InventoryListResponse|error {
    ...
    remote isolated function retrievesAListOfLocations(string apiVersion, map<string|string[]> headers = {}) returns LocationList|error {
    ...
    remote isolated function retrievesAListOfLocationsThatAFulfillmentOrderCanPotentiallyMoveTo(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfLocationsThatAFulfillmentOrderCanPotentiallyMoveToQueries queries) returns LocationsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/fulfillment_orders/${getEncodedUri(queries.fulfillmentOrderId)}/locations_for_move.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        return self.clientEp->get(resourcePath, headers);
    ...
    remote isolated function retrievesAListOfOrders(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfOrdersQueries queries) returns OrdersList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfPages(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfPagesQueries queries) returns PagesListResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/pages.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfPaymentsOnAParticularCheckout(string apiVersion, string token, map<string|string[]> headers = {}) returns PaymentsResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/checkouts/${getEncodedUri(token)}/payments.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfPriceRules(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfPriceRulesQueries queries) returns PriceRules|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfProductVariants(string apiVersion, string productId, map<string|string[]> headers = {}, *RetrievesAListOfProductVariantsQueries queries) returns ProductVariants|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}/variants.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfProducts(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfProductsQueries queries) returns ProductsResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfProvincesForACountry(string apiVersion, string countryId, map<string|string[]> headers = {}, *RetrievesAListOfProvincesForACountryQueries queries) returns ProvincesList|error {
    ...
    remote isolated function retrievesAListOfRecurringApplicationCharges(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfRecurringApplicationChargesQueries queries) returns RecurringApplicationCharges|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/recurring_application_charges.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfRefundsForAnOrder(string apiVersion, string orderId, map<string|string[]> headers = {}, *RetrievesAListOfRefundsForAnOrderQueries queries) returns Refunds|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/refunds.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfReports(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfReportsQueries queries) returns ReportList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/reports.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfShippingRates(string apiVersion, string token, map<string|string[]> headers = {}) returns AvailableShippingRates|ShippingRates|error {
    ...
    remote isolated function retrievesAListOfSmartCollections(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfSmartCollectionsQueries queries) returns SmartCollectionList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/smart_collections.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfStorefrontAccessTokensThatHaveBeenIssued(string apiVersion, map<string|string[]> headers = {}) returns StorefrontAccessTokens|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/storefront_access_tokens.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfTenderTransactions(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfTenderTransactionsQueries queries) returns TenderTransactions|error {
    ...
    remote isolated function retrievesAListOfTheShopSPolicies(string apiVersion, map<string|string[]> headers = {}) returns ShopPoliciesList|error {
    ...
    remote isolated function retrievesAListOfThemes(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfThemesQueries queries) returns ThemesList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/themes.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfTransactions(string apiVersion, string orderId, map<string|string[]> headers = {}, *RetrievesAListOfTransactionsQueries queries) returns TransactionsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/transactions.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfUrlRedirects(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfUrlRedirectsQueries queries) returns UrlList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/redirects.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfUsageCharges(string apiVersion, string recurringApplicationChargeId, map<string|string[]> headers = {}, *RetrievesAListOfUsageChargesQueries queries) returns UsageChargeList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/recurring_application_charges/${getEncodedUri(recurringApplicationChargeId)}/usage_charges.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAListOfWebhooks(string apiVersion, map<string|string[]> headers = {}, *RetrievesAListOfWebhooksQueries queries) returns SubscriptionsList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/webhooks.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesAPageCount(string apiVersion, map<string|string[]> headers = {}, *RetrievesAPageCountQueries queries) returns ArticlesCount|error {
    ...
    remote isolated function retrievesASingleApplicationCredit(string apiVersion, string aplicationCreditId, map<string|string[]> headers = {}, *RetrievesASingleApplicationCreditQueries queries) returns ApplicationCredit|error {
    ...
    remote isolated function retrievesASingleCarrierService(string apiVersion, string carrierServiceId, map<string|string[]> headers = {}) returns SingleCarrierService|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/carrier_services/${getEncodedUri(carrierServiceId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleCharge(string apiVersion, string recurringApplicationChargeId, map<string|string[]> headers = {}, *RetrievesASingleChargeQueries queries) returns SingleCharge|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/recurring_application_charges/${getEncodedUri(recurringApplicationChargeId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieves a single charge / Retrieves a single charge 
    remote isolated function retrievesASingleCharge1(string apiVersion, string recurringApplicationChargeId, string usageChargeId, map<string|string[]> headers = {}, *RetrievesASingleCharge1Queries queries) returns SingleUsageCharge|error {
    ...
    remote isolated function retrievesASingleCollection(string apiVersion, string collectionId, map<string|string[]> headers = {}, *RetrievesASingleCollectionQueries queries) returns SingleCollection|error {
    ...
    remote isolated function retrievesASingleCommentByItsId(string apiVersion, string commentId, map<string|string[]> headers = {}, *RetrievesASingleCommentByItsIdQueries queries) returns SingleCommentResponse|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieve a specific collection by its ID / Retrieve a specific collection by its ID 
    remote isolated function retrievesASingleCustomCollection(string apiVersion, string customCollectionId, map<string|string[]> headers = {}, *RetrievesASingleCustomCollectionQueries queries) returns SingleCustomCollection|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/custom_collections/${getEncodedUri(customCollectionId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieves a single customer 
    remote isolated function retrievesASingleCustomer(string apiVersion, string customerId, map<string|string[]> headers = {}, *RetrievesASingleCustomerQueries queries) returns CustomerResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers/${getEncodedUri(customerId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleDiscountCode(string apiVersion, string priceRuleId, string discountCodeId, map<string|string[]> headers = {}) returns SingleDiscountCode|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules/${getEncodedUri(priceRuleId)}/discount_codes/${getEncodedUri(discountCodeId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleEvent(string apiVersion, string eventId, map<string|string[]> headers = {}, *RetrievesASingleEventQueries queries) returns SingleEvent|error {
    ...
    remote isolated function retrievesASingleGiftCard(string apiVersion, string giftCardId, map<string|string[]> headers = {}, *RetrievesASingleGiftCardQueries queries) returns SingleGiftCard|error {
    ...
    remote isolated function retrievesASingleInventoryItemById(string apiVersion, string inventoryItemId, map<string|string[]> headers = {}) returns InventoryItem|error {
    ...
    remote isolated function retrievesASingleLocationByItsId(string apiVersion, string locationId, map<string|string[]> headers = {}) returns SingleLocation|error {
    ...
    remote isolated function retrievesASingleMarketingEvent(string apiVersion, string marketingEventId, map<string|string[]> headers = {}) returns MarketingEvent|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/marketing_events/${getEncodedUri(marketingEventId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleOrderRiskByItsId(string apiVersion, string orderId, string riskId, map<string|string[]> headers = {}) returns SingleOrderRisk|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/risks/${getEncodedUri(riskId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASinglePageByItsId(string apiVersion, string pageId, map<string|string[]> headers = {}, *RetrievesASinglePageByItsIdQueries queries) returns SinglePageResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/pages/${getEncodedUri(pageId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASinglePayment(string apiVersion, string token, string paymentId, map<string|string[]> headers = {}) returns SinglePaymentResponse|error {
    ...
    remote isolated function retrievesASinglePriceRule(string apiVersion, string priceRuleId, map<string|string[]> headers = {}) returns SinglePriceRule|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules/${getEncodedUri(priceRuleId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleProduct(string apiVersion, string productId, map<string|string[]> headers = {}, *RetrievesASingleProductQueries queries) returns SingleProduct|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleProvinceForACountry(string apiVersion, string countryId, string provinceId, map<string|string[]> headers = {}, *RetrievesASingleProvinceForACountryQueries queries) returns SingleProvince|error {
    ...
    remote isolated function retrievesASingleRedirect(string apiVersion, string redirectId, map<string|string[]> headers = {}, *RetrievesASingleRedirectQueries queries) returns SingleRedirect|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/redirects/${getEncodedUri(redirectId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleReport(string apiVersion, string reportId, map<string|string[]> headers = {}, *RetrievesASingleReportQueries queries) returns SingleReportResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/reports/${getEncodedUri(reportId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleScriptTag(string apiVersion, string scriptTagId, map<string|string[]> headers = {}, *RetrievesASingleScriptTagQueries queries) returns SingleScriptTag|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/script_tags/${getEncodedUri(scriptTagId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleSmartCollection(string apiVersion, string smartCollectionId, map<string|string[]> headers = {}, *RetrievesASingleSmartCollectionQueries queries) returns SmartCollectionResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/smart_collections/${getEncodedUri(smartCollectionId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleTheme(string apiVersion, string themeId, map<string|string[]> headers = {}, *RetrievesASingleThemeQueries queries) returns SingleTheme|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/themes/${getEncodedUri(themeId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASingleUser(string apiVersion, string userId, map<string|string[]> headers = {}) returns SingleUser|error {
    ...
    remote isolated function retrievesASpecificCollectByItsId(string apiVersion, string collectId, map<string|string[]> headers = {}, *RetrievesASpecificCollectByItsIdQueries queries) returns CollectResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/collects/${getEncodedUri(collectId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASpecificCounty(string apiVersion, string countryId, map<string|string[]> headers = {}, *RetrievesASpecificCountyQueries queries) returns CountryResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/countries/${getEncodedUri(countryId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASpecificFulfillmentEvent(string apiVersion, string orderId, string fulfillmentId, map<string|string[]> headers = {}, *RetrievesASpecificFulfillmentEventQueries queries) returns FulfillmentEventResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/fulfillments/${getEncodedUri(fulfillmentId)}/events/${getEncodedUri(queries.eventId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        return self.clientEp->get(resourcePath, headers);
    ...
    remote isolated function retrievesASpecificFulfillmentOrder(string apiVersion, string fulfillmentOrderId, map<string|string[]> headers = {}) returns SingleFulfillmentOrder|error {
    ...
    remote isolated function retrievesASpecificOrder(string apiVersion, string orderId, map<string|string[]> headers = {}) returns SingleOrderResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesASpecificRefund(string apiVersion, string orderId, string refundId, map<string|string[]> headers = {}, *RetrievesASpecificRefundQueries queries) returns RefundResponse|error {
    ...
    remote isolated function retrievesASpecificTransaction(string apiVersion, string orderId, string transactionId, map<string|string[]> headers = {}, *RetrievesASpecificTransactionQueries queries) returns TransactionResponse|error {
    ...
    remote isolated function retrievesAllApplicationCredits(string apiVersion, map<string|string[]> headers = {}, *RetrievesAllApplicationCreditsQueries queries) returns ApplicationCredits|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function retrievesAllOrdersBelongingToACustomer(string apiVersion, string customerId, map<string|string[]> headers = {}) returns Orders|error {
    ...
    remote isolated function retrievesAnApplicationCharge(string apiVersion, string applicationChargeId, map<string|string[]> headers = {}, *RetrievesAnApplicationChargeQueries queries) returns ApplicationChargeResult|error {
    ...
    remote isolated function retrievesAnOrderCount(string apiVersion, map<string|string[]> headers = {}, *RetrievesAnOrderCountQueries queries) returns ObjectCount|error {
    ...
    remote isolated function retrievesDetailsForASingleCustomerAddress(string apiVersion, string customerId, string addressId, map<string|string[]> headers = {}) returns SingleCustomerAddress|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers/${getEncodedUri(customerId)}/addresses/${getEncodedUri(addressId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function retrievesFulfillmentsAssociatedWithAFulfillmentOrder(string apiVersion, map<string|string[]> headers = {}, *RetrievesFulfillmentsAssociatedWithAFulfillmentOrderQueries queries) returns FulfillmentList|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/fulfillment_orders/${getEncodedUri(queries.fulfillmentOrderId)}/fulfillments.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        return self.clientEp->get(resourcePath, headers);
    ...
    remote isolated function retrievesFulfillmentsAssociatedWithAnOrder(string apiVersion, string orderId, map<string|string[]> headers = {}, *RetrievesFulfillmentsAssociatedWithAnOrderQueries queries) returns FulfillmentListForOrder|error {
    ...
    remote isolated function retrievesTheCurrentlyLoggedInUser(string apiVersion, map<string|string[]> headers = {}) returns SingleUser|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function retrievesTheLocationOfADiscountCode(string apiVersion, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    remote isolated function retrievesTheShopSConfiguration(string apiVersion, map<string|string[]> headers = {}, *RetrievesTheShopSConfigurationQueries queries) returns ShopConfigurations|error {
    ...
    remote isolated function returnAListOfAllBalanceTransactions(string apiVersion, map<string|string[]> headers = {}, *ReturnAListOfAllBalanceTransactionsQueries queries) returns TransactionsListForPayout|error {
    ...
    remote isolated function returnAListOfAllDisputes(string apiVersion, map<string|string[]> headers = {}, *ReturnAListOfAllDisputesQueries queries) returns Disputes|error {
    ...
    remote isolated function returnAListOfAllPayouts(string apiVersion, map<string|string[]> headers = {}, *ReturnAListOfAllPayoutsQueries queries) returns PayoutsList|error {
    ...
    remote isolated function returnASingleDispute(string apiVersion, string disputeId, map<string|string[]> headers = {}) returns SingleDispute|error {
    ...
    remote isolated function returnASinglePayout(string apiVersion, string payoutId, map<string|string[]> headers = {}) returns SinglePayout|error {
    ...
    remote isolated function returnTheCurrentBalance(string apiVersion, map<string|string[]> headers = {}) returns AccountCurrentBalance|error {
    ...
    remote isolated function returnsEvidenceAssociatedWithTheDispute(string apiVersion, string disputeId, map<string|string[]> headers = {}) returns DisputeEvidenceResponse|error {
    ...
    remote isolated function returnsEvidenceAssociatedWithTheDisputeCopy(string apiVersion, string disputeId, DisputeIdDisputeEvidencesJsonBody payload, map<string|string[]> headers = {}) returns DisputeEvidenceResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/shopify_payments/disputes/${getEncodedUri(disputeId)}/dispute_evidences.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function searchesForCustomersThatMatchASuppliedQuery(string apiVersion, map<string|string[]> headers = {}, *SearchesForCustomersThatMatchASuppliedQueryQueries queries) returns Customers|error {
    ...
    remote isolated function searchesForGiftCards(string apiVersion, map<string|string[]> headers = {}, *SearchesForGiftCardsQueries queries) returns GiftCardSearch|error {
    ...
    remote isolated function sendAnInvoice(string apiVersion, string draftOrderId, DraftOrderIdSendInvoiceJsonBody payload, map<string|string[]> headers = {}) returns InvoiceResponse|error {
    ...
    remote isolated function sendsACancellationRequest(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdCancellationRequestJsonBody payload, map<string|string[]> headers = {}) returns FulfillmentOrder|error {
    ...
    remote isolated function sendsAFulfillmentRequest(string apiVersion, string fulfillmentOrderId, FulfillmentOrderIdFulfillmentRequestJsonBody payload, map<string|string[]> headers = {}) returns OriginalFulfillmentOrder|error {
    ...
    remote isolated function sendsAnAccountInviteToACustomer(string apiVersion, string customerId, CustomerIdSendInviteJsonBody payload, map<string|string[]> headers = {}) returns AccountInvite|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Move a fulfillment order to a new location / Move a fulfillment order to a new location 
    remote isolated function setsDeadlineForFulfillmentOrders(string apiVersion, FulfillmentOrdersSetFulfillmentOrdersDeadlineJsonBody payload, map<string|string[]> headers = {}) returns MoveFulfillmentOrderResponse|error {
    ...
    remote isolated function setsTheDefaultAddressForACustomer(string apiVersion, string customerId, string addressId, string payload, map<string|string[]> headers = {}) returns CustomerDefaultAddress|error {
    ...
    remote isolated function setsTheInventoryLevelForAnInventoryItemAtALocation(string apiVersion, InventoryLevelsSetJsonBody payload, map<string|string[]> headers = {}) returns AvailableInventory|error {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function shopCreateAMetafield(string apiVersion, ApiVersionMetafieldsJsonBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function shopDeletesAMetafieldByItsId(string apiVersion, string metafieldId, string payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function shopRetrieveACountOfAResourceSMetafields(string apiVersion, map<string|string[]> headers = {}) returns ObjectCount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function shopRetrieveAListOfMetafieldsFromTheResourceSEndpoint(string apiVersion, map<string|string[]> headers = {}, *ShopRetrieveAListOfMetafieldsFromTheResourceSEndpointQueries queries) returns error? {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/metafields.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function shopRetrieveASpecificMetafield(string apiVersion, string metafieldId, map<string|string[]> headers = {}, *ShopRetrieveASpecificMetafieldQueries queries) returns MetafieldResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/metafields/${getEncodedUri(metafieldId)}.json`;
        map<anydata> queryParam = {...queries};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function shopUpdatesAMetafield(string apiVersion, string metafieldId, string payload, map<string|string[]> headers = {}) returns Metafield|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/metafields/${getEncodedUri(metafieldId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updateAMobilePlatformApplication(string apiVersion, string mobilePlatformApplicationId, MobilePlatformApplicationsmobilePlatformApplicationIdJsonBody payload, map<string|string[]> headers = {}) returns MobilePlatformApplicationResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/mobile_platform_applications/${getEncodedUri(mobilePlatformApplicationId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesACommentOfAnArticle(string apiVersion, string commentId, CommentscommentIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateCommentResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/comments/${getEncodedUri(commentId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Retrieves a single customer 
    remote isolated function updatesACustomer(string apiVersion, string customerId, UpdateCustomer payload, map<string|string[]> headers = {}) returns CustomerResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers/${getEncodedUri(customerId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAMarketingEvent(string apiVersion, string marketingEventId, MarketingEventsmarketingEventIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateMarketingEvent|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/marketing_events/${getEncodedUri(marketingEventId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + apiVersion - The API version
    # + headers - Headers to be sent with the request 
    remote isolated function updatesAMetafield(string apiVersion, string ownerId, string ownerResource, string metafieldId, string payload, map<string|string[]> headers = {}) returns MetafieldResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/${getEncodedUri(ownerId)}/${getEncodedUri(ownerResource)}/metafields/${getEncodedUri(metafieldId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAPage(string apiVersion, string pageId, PagespageIdJsonBody payload, map<string|string[]> headers = {}) returns UpdatePageResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/pages/${getEncodedUri(pageId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAProduct(string apiVersion, string productId, UpdateProduct payload, map<string|string[]> headers = {}) returns ProductObject|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/products/${getEncodedUri(productId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAReport(string apiVersion, string reportId, ReportsreportIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateReportResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/reports/${getEncodedUri(reportId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAScriptTag(string apiVersion, string scriptTagId, ScriptTagsscriptTagIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateScriptTagResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/script_tags/${getEncodedUri(scriptTagId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnArticle(string apiVersion, string blogId, string articleId, ArticlesarticleIdJsonBody payload, map<string|string[]> headers = {}) returns SingleArticle|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/blogs/${getEncodedUri(blogId)}/articles/${getEncodedUri(articleId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingAPriceRule(string apiVersion, string priceRuleId, PriceRulespriceRuleIdJsonBody payload, map<string|string[]> headers = {}) returns UpdatePriceRule|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules/${getEncodedUri(priceRuleId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingCountry(string apiVersion, string countryId, CountriescountryIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateCountryTaxRate|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/countries/${getEncodedUri(countryId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingCustomCollection(string apiVersion, string customCollectionId, CustomCollectionscustomCollectionIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateCustomCollection|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/custom_collections/${getEncodedUri(customCollectionId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingCustomerAddress(string apiVersion, string customerId, string addressId, AddressesaddressIdJsonBody payload, map<string|string[]> headers = {}) returns PostalCodeResult|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/customers/${getEncodedUri(customerId)}/addresses/${getEncodedUri(addressId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingDiscountCode(string apiVersion, string priceRuleId, string discountCodeId, DiscountCodesdiscountCodeIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateDiscountCode|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/price_rules/${getEncodedUri(priceRuleId)}/discount_codes/${getEncodedUri(discountCodeId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingGiftCard(string apiVersion, string giftCardId, GiftCardsgiftCardIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateGiftCard|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/gift_cards/${getEncodedUri(giftCardId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingInventoryItem(string apiVersion, string inventoryItemId, InventoryItemsinventoryItemIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateInventoryItem|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/inventory_items/${getEncodedUri(inventoryItemId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingProvinceForACountry(string apiVersion, string countryId, string provinceId, ProvincesprovinceIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateProvinceResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/countries/${getEncodedUri(countryId)}/provinces/${getEncodedUri(provinceId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingRedirect(string apiVersion, string redirectId, RedirectsredirectIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateRedirect|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/redirects/${getEncodedUri(redirectId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnExistingSmartCollection(string apiVersion, string smartCollectionId, SmartCollectionssmartCollectionIdJsonBody payload, map<string|string[]> headers = {}) returns UpdateSmartCollection|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/smart_collections/${getEncodedUri(smartCollectionId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnOrder(string apiVersion, string orderId, UpdateOrder payload, map<string|string[]> headers = {}) returns UpdateOrderResponse|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesAnOrderRisk(string apiVersion, string orderId, string riskId, UpdateOrderRisk payload, map<string|string[]> headers = {}) returns OrderRiskObject|error {
        string resourcePath = string `/admin/api/${getEncodedUri(apiVersion)}/orders/${getEncodedUri(orderId)}/risks/${getEncodedUri(riskId)}.json`;
        map<anydata> queryParam = {};
        queryParam["x-shopify-access-token"] = self.apiKeyConfig.x\-shopify\-access\-token;
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function updatesTheCappedAmountOfARecurringApplicationCharge(string apiVersion, string recurringApplicationChargeId, string payload, map<string|string[]> headers = {}, *UpdatesTheCappedAmountOfARecurringApplicationChargeQueries queries) returns CappedAmountCharge|error {
    ...
    remote isolated function updatesTheOrderingTypeOfProductsInASmartCollection(string apiVersion, string smartCollectionId, record {} payload, map<string|string[]> headers = {}) returns record {}|error {
    ...
    remote isolated function updatesTheTrackingInformationForAFulfillment(string apiVersion, string fulfillmentId, FulfillmentIdUpdateTrackingJsonBody payload, map<string|string[]> headers = {}) returns Fulfillment|error {
    ...
    remote isolated function uploadAFileToADispute(string apiVersion, string disputeId, DisputeIdDisputeFileUploadsJsonBody payload, map<string|string[]> headers = {}) returns DisputeFileUpload|error {
